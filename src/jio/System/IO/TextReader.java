...
import jio.System.IO.*;public abstract class TextReader extends MarshalByRefObject implements IDisposable {protected NObject javonetHandle; public TextReader(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
