...
import jio.System.IO.*;public abstract class Stream extends MarshalByRefObject implements IDisposable {protected NObject javonetHandle; public Stream(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
