...
import jio.System.Drawing.*;public abstract class Image extends MarshalByRefObject implements ISerializable,ICloneable,IDisposable {protected NObject javonetHandle; public Image(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
