...
import jio.System.Drawing.*;public class Graphics extends MarshalByRefObject implements IDisposable,IDeviceContext {protected NObject javonetHandle; public Graphics(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
