...
import jio.System.Drawing.*;public class Color extends ValueType {public NObject javonetHandle; public Color(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
