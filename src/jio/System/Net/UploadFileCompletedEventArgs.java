...
import jio.System.Net.*;public class UploadFileCompletedEventArgs extends AsyncCompletedEventArgs {public NObject javonetHandle; public UploadFileCompletedEventArgs(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
