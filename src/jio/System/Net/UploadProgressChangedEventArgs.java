...
import jio.System.Net.*;public class UploadProgressChangedEventArgs extends ProgressChangedEventArgs {public NObject javonetHandle; public UploadProgressChangedEventArgs(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
