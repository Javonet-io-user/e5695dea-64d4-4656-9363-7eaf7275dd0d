...
import jio.System.Runtime.Serialization.*;public class WebHeaderCollection extends NameValueCollection implements ICollection,IEnumerable,ISerializable,IDeserializationCallback {protected NObject javonetHandle; public WebHeaderCollection (){  super((NObject) null); try {  javonetHandle = Javonet.New("WebHeaderCollection"); super.setJavonetHandle(javonetHandle); } catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public WebHeaderCollection(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
