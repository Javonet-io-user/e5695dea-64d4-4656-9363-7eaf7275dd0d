...
import jio.System.Net.*;public class DownloadProgressChangedEventArgs extends ProgressChangedEventArgs {public NObject javonetHandle; public DownloadProgressChangedEventArgs(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
