...
import jio.System.*;
import jio.System.Collections.*;public class Dictionary<TKey,TValue> implements jio.System.Collections.IEnumerable,jio.System.Collections.IDictionary,jio.System.Collections.ICollection,ISerializable,IDeserializationCallback {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public jio.System.Collections.Generic.IEqualityComparer<TKey> getComparer (){ try { return ConvertToConcreteInterfaceImplementation((NObject) javonetHandle.get("Comparer"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public KeyCollection<TKey,TValue> getKeys (){ try { return new KeyCollection<TKey,TValue>((NObject)javonetHandle.get("Keys"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
            public ValueCollection<TKey,TValue> getValues (){ try { return new ValueCollection<TKey,TValue>((NObject)javonetHandle.get("Values"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public KeyValuePair<TKey,TValue> getCurrent (){ try { return javonetHandle.get("Current");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public Enumerator(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
