...
import jio.System.*;
import jio.System.Collections.*;public abstract class NameObjectCollectionBase implements ICollection,IEnumerable,ISerializable,IDeserializationCallback {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public KeysCollection getKeys (){ try { return new KeysCollection((NObject)javonetHandle.get("Keys"));} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public NameObjectCollectionBase(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
	 ...
	 * Method
	 */
            public java.lang.Boolean get_IsSynchronized (){ try { return javonetHandle.invoke("get_IsSynchronized");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }public static class KeysCollection implements ICollection,IEnumerable {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public java.lang.Integer getCount (){ try { return javonetHandle.get("Count");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return 0;} }public KeysCollection(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
                    this.javonetHandle = handle;
                }/**
	 * Method
	 */
