...
import jio.System.*;public class ReadOnlyCollection<T> implements jio.System.Collections.IEnumerable,jio.System.Collections.IList,jio.System.Collections.ICollection {protected NObject javonetHandle; /**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public T get_Item (java.lang.Integer index, Class<?> returnType){ try { return (T)Convert(javonetHandle.generic(getReturnObjectName(returnType)).invoke("get_Item",index), returnType);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }public ReadOnlyCollection (jio.System.Collections.Generic.IList<T> list){ try {  javonetHandle = Javonet.New("ReadOnlyCollection",list);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public ReadOnlyCollection(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
	 ...
	 * Method
	 */
            public java.lang.Boolean Contains (T value){ try { return javonetHandle.generic(getGetObjectName(value)).invoke("Contains",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return false;} }/**
	 * Method
	 */
	 ...
	 * Method
	 */
            public java.lang.Integer IndexOf (T value){ try { return javonetHandle.generic(getGetObjectName(value)).invoke("IndexOf",value);} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return 0;} }/**
	 * Method
	 */
