...
import jio.System.Runtime.Serialization.*;public abstract class Delegate implements ICloneable,ISerializable {protected NObject javonetHandle; public Delegate(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
