...
import jio.System.Runtime.Serialization.*;public abstract class MulticastDelegate extends Delegate implements ISerializable {protected NObject javonetHandle; public MulticastDelegate(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
