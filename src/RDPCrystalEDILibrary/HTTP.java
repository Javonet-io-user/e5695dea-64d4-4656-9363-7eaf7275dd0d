...
import jio.System.Net.*;public class HTTP extends Component {protected NObject javonetHandle; /**
	 ...
	 */
            public java.lang.String getCommand (){ try { return  (java.lang.String) javonetHandle.get("Command");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return "";} }public HTTP (){  super((NObject) null); try {  javonetHandle = Javonet.New("HTTP"); super.setJavonetHandle(javonetHandle); javonetHandle.addEventListener("FileUploadCompleted", new com.javonet.api.INEventListener() {
                    ...
                    {
                        for (UploadFileCompletedDelegate handler : _FileUploadCompletedListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], UploadFileCompletedEventArgs.class));}}});javonetHandle.addEventListener("DownloadFileCompleted", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (DownloadFileCompletedDelegate handler : _DownloadFileCompletedListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], AsyncCompletedEventArgs.class));}}});javonetHandle.addEventListener("DownloadFileProgressChanged", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
                        for (DownloadFileProgressChangedDelegate handler : _DownloadFileProgressChangedListeners) {handler.Invoke(Convert(objects[0], NObject.class),Convert(objects[1], DownloadProgressChangedEventArgs.class));}}});javonetHandle.addEventListener("FileUploadProgressChanged", new com.javonet.api.INEventListener() {
                    @Override
                    public void eventOccurred(Object[] objects)
                    {
	 ...
	 * Event
	 */
            private java.util.ArrayList< UploadFileCompletedDelegate> _FileUploadCompletedListeners = new java.util.ArrayList<UploadFileCompletedDelegate>();
	 ...
	 * Event
	 */
            private java.util.ArrayList< DownloadFileCompletedDelegate> _DownloadFileCompletedListeners = new java.util.ArrayList<DownloadFileCompletedDelegate>();
	 ...
	 * Event
	 */
            private java.util.ArrayList< DownloadFileProgressChangedDelegate> _DownloadFileProgressChangedListeners = new java.util.ArrayList<DownloadFileProgressChangedDelegate>();
	 ...
	 * Event
	 */
            private java.util.ArrayList< UploadFileProgressChangedDelegate> _FileUploadProgressChangedListeners = new java.util.ArrayList<UploadFileProgressChangedDelegate>();
            ...
            }public interface UploadFileCompletedDelegate { public void Invoke (NObject sender,UploadFileCompletedEventArgs e);}public interface UploadFileProgressChangedDelegate { public void Invoke (NObject sender,UploadProgressChangedEventArgs e);}public interface DownloadFileCompletedDelegate { public void Invoke (NObject sender,AsyncCompletedEventArgs e);}public interface DownloadFileProgressChangedDelegate { public void Invoke (NObject sender,DownloadProgressChangedEventArgs e);}	static {
		try {
